...
import com.xy.music.shake.ShakeDetector;
import com.xy.music.shake.ShakeDetector.OnShakeListener;
...
public class MediaService extends Service implements IConstants, OnShakeListener {
	...
	private static final String PAUSE_BROADCAST_NAME = "com.xy.music.pause.broadcast";
	private static final String NEXT_BROADCAST_NAME = "com.xy.music.next.broadcast";
	private static final String PRE_BROADCAST_NAME = "com.xy.music.pre.broadcast";
