...
import com.xy.music.utils.ServiceUtil;
import com.xy.music.utils.StringHelper;
import com.xy.music.view.KeyBoardKeyView;
...
public class MusicListSearchActivity extends Activity implements
	...
	private void initConnection() {
		...
		Intent intent = new Intent("com.xy.music.service.MediaService");
		bindService(ServiceUtil.createExplicitFromImplicitIntent(this, intent), mServiceConnection, Context.BIND_AUTO_CREATE);
	}
