...
public interface IConstants {
	...
	public static final String BROADCAST_NAME = "com.xy.music.broadcast";
	public static final String SERVICE_NAME = "com.xy.music.service.MediaService";
	public static final String BROADCAST_QUERY_COMPLETE_NAME = "com.xy.music.querycomplete.broadcast";
	public static final String BROADCAST_CHANGEBG = "com.xy.music.changebg";
	public static final String BROADCAST_SHAKE = "com.xy.music.shake";
	
	//是否开启了振动模式
	public static final String SHAKE_ON_OFF = "SHAKE_ON_OFF";
	
	public static final String SP_NAME = "com.xy.music_preference";
